...
<body>
  ...
  <div class="wrapper">
    ...
    <div class="menu-list">
      ...
      <div class="menu-balance menu">
        ...
        <select id="account_to_display" class="select-account"></select>
      ...
      <div class="menu-wallet menu">
        ...
        <div class="wrapper-content">
          ...
          <span
            class="menu-content tag-icon__wrapper"
            data-toggle="modal"
            data-target="#modal_add_category"
          >
            <svg class="icon tag-icon" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
        ...
        <div class="menu-title"><h3>Adicionar conta | categoria</h3></div>
  ...
  <!-- Adicionar categoria -->
  <?php require APPROOT . '/views/painel/modalAddCategory.php' ?>
